...
class ProductsManager(models.Manager):
    ...
    def get_prodcut_by_category(self,category_name):
    ...
    def search(self,query):
        ...
        return Product.object.filter(lookup ,active=True).distinct()
...
class ProductGallery(models.Model):
    title = models.CharField(max_length=150, verbose_name='عنوان')
    image = models.ImageField(upload_to=product_gallery_path, verbose_name='تصویر')
